...
# base
#execute "sh linux/arch/pacman/link.sh"
...
execute "sh linux/hardware/libinput/link.sh"
execute "sh linux/desktop/locale/link.sh"
execute "sh linux/services/openvpn/setup.sh"
execute "sh linux/services/resolv/link.sh"
execute "sh linux/desktop/rofi/setup.sh"
execute "sh linux/desktop/rofi/link.sh"
execute "sh linux/desktop/user-dirs/link.sh"
execute "sh linux/desktop/xorg/setup.sh"
execute "sh linux/desktop/xorg/link.sh"
execute "sh linux/desktop/awesome/setup.sh"
execute "sh linux/desktop/awesome/link.sh"
...
execute "sh linux/desktop/input-method/setup-rime-ice.sh"
...
# docker
execute "sh linux/services/docker/setup.sh"
execute "sh linux/services/docker/link.sh"

# redis
execute "sh linux/services/redis/setup.sh"
...
execute "sh linux/scripts/dotfiles-setup-scripts"
