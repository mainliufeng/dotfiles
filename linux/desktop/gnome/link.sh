...
# sudo cp -rf ~/dotfiles/linux/desktop/gnome/extensions/tilingws@mainliufeng ~/.local/share/gnome-shell/extensions
# sudo glib-compile-schemas ~/.local/share/gnome-shell/extensions/tilingws@mainliufeng/schemas

python ~/dotfiles/linux/desktop/gnome/scripts/clean-keys.py
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom0/ command "'kitt'"
gsettings set org.gnome.mutter dynamic-workspaces false
gsettings set org.gnome.desktop.wm.preferences num-workspaces 10

# paperwm
cat ~/dotfiles/linux/desktop/gnome/org.gnome.shell.extensions.paperwm.keybindings.dump | dconf load /org/gnome/shell/extensions/paperwm/keybindings/
