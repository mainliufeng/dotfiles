...
awful.rules.rules = {
    ...
    -- Scratchpad
    {
        ...
        properties = {
            floating = true,
            placement = awful.placement.centered + awful.placement.stretch_up + awful.placement.maximize_horizontally
            --placement = awful.placement.centered + awful.placement.stretch_left + awful.placement.maximize_vertically
            --placement = awful.placement.centered + awful.placement.stretch_right + awful.placement.maximize_vertically
        }
    },
