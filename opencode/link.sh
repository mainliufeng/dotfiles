...
if [ -f ~/dotfiles/opencode/oh-my-opencode.json ]; then
    ln -svfn ~/dotfiles/opencode/oh-my-opencode.json ~/.config/opencode/oh-my-opencode.json
...
echo "  - librarian/explore/document-writer/multimodal-looker: GLM-4.7 (智谱AI)"